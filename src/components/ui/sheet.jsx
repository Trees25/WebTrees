...
function SheetTrigger({ asChild = false, render, ...props }) {
  return (
    <SheetPrimitive.Trigger
      data-slot="sheet-trigger"
      // Si usas asChild, Slot se encarga de fusionar el Trigger con tu Button
...
function SheetClose({ asChild = false, render, ...props }) {
  return (
    ...
    <SheetPortal>
      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            data-slot="sheet-close"
            // Arreglado para que el Button sea el contenedor del icono, no un padre extra
            render={
              <Button
                variant="ghost"
