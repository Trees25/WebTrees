...
const allProjects = [
  {
    id: 1,
    title: "Portafolio - KaiserJagger",
    category: "Páginas Web",
    imgSrc: kaiserjagger1,
    link: "https://kaiserjagger.com",
    status: "Finalizado",
  },
  {
    id: 2,
    title: "Landing Page - Anti-Robo-Auto",
    category: "Páginas Web",
    imgSrc: anti_robo_auto,
    link: "#",
    status: "Finalizado",
  },
  {
  ...
  },
  {
    ...
    imgSrc: pos_ventaLogo,
    link: "#",
    status: "En Desarrollo",
  },
  {
    id: 5,
    title: "Sistema de Gestion de Stock - NN Lubricentro",
    category: "Sistemas Personalizados",
    imgSrc: sistNN,
    link: "#",
    status: "Finalizado",
  ...
  {
    id: 6,
    title: "Generador de Presupuestos - Cortineria San Juan",
    category: "Sistemas Personalizados",
    imgSrc: sist_cortineria,
    link: "#",
    status: "Finalizado",
  },
  {
    id: 7,
    title: "Sistema POS/ERP con Facturación (ARCA) - Allpack",
    category: "Aplicación Web",
    imgSrc: sist_allpack,
    link: "https://pos-trees.netlify.app/",
    status: "Finalizado",
  },
];
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-black text-white tracking-tight mb-6">
            Nuestros{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#5EADF2] to-[#296cf2]">
              Trabajos
            </span>
          </h1>
          <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed">
            Descubrí cómo ayudamos a marcas y negocios a escalar al siguiente
            nivel a través del diseño moderno y desarrollo robusto.
          </p>
        </motion.div>
        ...
        {filteredProjects.length === 0 && (
          ...
          >
            <p className="text-gray-400 text-lg">
              Próximamente estaremos subiendo más trabajos.
            </p>
          </motion.div>
        )}
      </div>
